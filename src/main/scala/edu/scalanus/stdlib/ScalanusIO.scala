...
object ScalanusIO extends ScalanusLib{
  ...
  def print(args: Any*): Unit = args.foreach(System.out.print)

  def println(args: Any*): Unit = args.foreach(System.out.println)

  def readLine(): Any = scala.io.StdIn.readLine()
